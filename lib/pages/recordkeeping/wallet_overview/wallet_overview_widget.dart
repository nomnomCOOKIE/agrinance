...
import 'wallet_overview_model.dart';
export 'wallet_overview_model.dart';

class WalletOverviewWidget extends StatefulWidget {
  const WalletOverviewWidget({super.key});

  static String routeName = 'WalletOverview';
  static String routePath = '/walletOverview';
...
class _WalletOverviewWidgetState extends State<WalletOverviewWidget> {
  late WalletOverviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WalletOverviewModel());
  }
                    ...
                    children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed(
                                            IncomeRecordNewWidget.routeName);
                                      },
                                      text: 'Add',
                                      options: FFButtonOptions(
                                        height: 36.0,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed(
                                            RemoveExpensesWidget.routeName);
                                      },
                                      text: 'Remove',
                                      options: FFButtonOptions(
                                        height: 36.0,
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed(
                                            ExpenseRecordAddWidget.routeName);
                                      },
                                      text: 'Add',
                                      options: FFButtonOptions(
                                        height: 36.0,
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(SeasonSummaryWidget.routeName);
                          },
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Summary of expenses, yields, and profits.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                                VisualGraphsAndTrendsWidget.routeName);
                          },
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Cost distribution, historical data.',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.inter(
